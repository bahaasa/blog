            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="{{ route('front.homepage')}}"> <img src="{{asset('uploads/settings/'.$sett->logo)}}" alt="logo"> </a>
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        @foreach ($cat as $c)
                                        <a class="dropdown-item" href="{{ route('front.cat',$c->id) }}">{{ $c->name }}</a>
                                        @endforeach
