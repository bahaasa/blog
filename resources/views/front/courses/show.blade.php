                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item">
                            ...
                            <p>Home<span>/</span>Course Details <span>{{ $course->cat->name }}</span><span>{{ $course->name }}</span></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 right-contents">
                    ...
                    <form class="form-contact contact_form" action="{{ route('front.message.enroll') }}" method="post" id="contactForm" >
                      ...
                      <div class="row">
                        ...
                        <div class="col-12">
                          <div class="form-group">
                            <input class="form-control" name="spec"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Spec'" placeholder = 'Enter spec'>
                          </div>
                        </div>
                      </div>
